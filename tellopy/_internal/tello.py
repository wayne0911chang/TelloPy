...
class Tello(object):
    ...
    def __init__(self, ifname, port=9000):
        ...
        # interface name
        self.ifname = ifname;
        print("interface neame: {}".format(self.ifname));
        ...
        # set socket options
        # socket binded to device
        self.sock.setsockopt(socket.SOL_SOCKET, 25, self.ifname.encode());
